            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-4 col-md-4">
                  <div class="card text-white bg-secondary">
                    <div class="card-body pb-0">
                      <h4 class="mb-0">
                          <asp:Label ID="LabelSilver" runat="server" Text="Label"></asp:Label>  
                      </h4>
                      <p>Silver</p>
                    </div>
                  </div>
                 ...
                 <div class="col-sm-6 col-lg-4 col-md-4">
                  <div class="card text-white bg-warning">
                    <div class="card-body pb-0">
                      <h4 class="mb-0">
                        <asp:Label ID="LabelGold" runat="server" Text="Label"></asp:Label>
                      </h4>
                      <p>Gold</p>
                    </div>
                  </div>
                ...
                <div class="col-sm-6 col-lg-4 col-md-4">
                  <div class="card text-white bg-info">
                    <div class="card-body pb-0">
                      <h4 class="mb-0">
                        <asp:Label ID="LabelOther" runat="server" Text="Label"></asp:Label>
                      </h4>
                      <p>Other</p>
                    </div>
                  </div>
                ...
                <div class="col-sm-12 col-lg-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <asp:GridView ID="GridView2" runat="server"  CssClass="table table-striped" AutoGenerateColumns="False" DataKeyNames="c_id" DataSourceID="SqlDataSource2">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="First Name" SortExpression="c_fname">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("c_fname") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("c_fname") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="M Name" SortExpression="c_mname">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("c_mname") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("c_mname") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Last Name" SortExpression="c_lname">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("c_lname") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\serverndb.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT TOP 10  [c_id], [c_fname], [c_mname], [c_lname], [city], [create_date] FROM [customer] WHERE ([isactive] = @isactive) ORDER BY [create_date] DESC">
                                <SelectParameters>
                ...
                <div class="col-sm-12 col-lg-12 col-md-12">
                     ...
                     <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\serverndb.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT TOP  10  [c_id], [c_fname], [c_mname], [c_lname], [city], [updated_date] FROM [customer] WHERE ([isactive] = @isactive) ORDER BY updated_date">
                                <SelectParameters>
