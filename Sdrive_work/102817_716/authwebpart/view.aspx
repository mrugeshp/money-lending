                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                 <strong>Total Debit Due Amount: </strong><asp:Label ID="lbltotmor" runat="server" Text="0"></asp:Label>
                            </p>
                            <p>
                                 <strong>Total Debit Interest: </strong><asp:Label ID="lbltotint" runat="server" Text="Label"></asp:Label>
                            </p>
                             <p>
                                 <strong>Payable Amount: </strong><asp:Label ID="lblpayamt" runat="server" Text="Label"></asp:Label>
                            </p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row datepicker">
                                ...
                                <div class="col-md-9 col-lg-9">
                                    <asp:TextBox ID="creditdebitDate" runat="server" CssClass="input-sm form-control"></asp:TextBox>
                                </div>
                            </div>
                        </div>  
