                            ...
                            <WizardSteps>
                                ...
                                <asp:WizardStep runat="server" title="Step 2">
                                    ...
                                    <table class="auto-style1">
                                        ...
                                        <tr>
                                            <td class="auto-style29">
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\snewdb.mdf;Integrated Security=True" DeleteCommand="DELETE FROM [cust_mor] WHERE [cust_mor_id] = @cust_mor_id" InsertCommand="INSERT INTO [cust_mor] ([item_type], [item_name], [gross_weight], [rate], [amount]) VALUES (@item_type, @item_name, @gross_weight, @rate, @amount)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [cust_mor_id], [item_type], [item_name], [gross_weight], [rate], [amount] FROM [cust_mor] WHERE ([c_id] = @c_id)" UpdateCommand="UPDATE [cust_mor] SET [item_type] = @item_type, [item_name] = @item_name, [gross_weight] = @gross_weight, [rate] = @rate, [amount] = @amount WHERE [cust_mor_id] = @cust_mor_id">
                                                    <DeleteParameters>
                                                    ...
                                                    <SelectParameters>
                                                        <asp:ControlParameter ControlID="TextBox8" DefaultValue="3" Name="c_id" PropertyName="Text" Type="Int32" />
                                                    </SelectParameters>
                                                    <UpdateParameters>
                                                        <asp:Parameter Name="item_type" Type="String" />
                                                        <asp:Parameter Name="item_name" Type="String" />
                                            ...
                                            <td class="auto-style12">&nbsp;</td>
                                            <td class="auto-style14">
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cust_mor_id" DataSourceID="SqlDataSource1">
                                                    <Columns>
