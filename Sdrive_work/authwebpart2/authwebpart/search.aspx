...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td>
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:authuserConnectionString %>" SelectCommand="SELECT c_id, c_fname, c_mname, c_lname, address, city, email_id, mobile_no, cphoto_path, mphoto_path, create_date, created_date, updated_date, interest_rate, credit_limit, isactive FROM customer WHERE (c_fname LIKE '%' + @c_fname + '%') OR (c_mname LIKE '%' + @c_mname + '%') OR (c_lname LIKE '%' + @c_lname + '%') ORDER BY create_date DESC">
                    <SelectParameters>
