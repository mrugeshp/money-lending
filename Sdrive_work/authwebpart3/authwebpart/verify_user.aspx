...
<body>
    <form id="form1" runat="server">
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:authuserConnectionString %>" DeleteCommand="DELETE FROM [reg_user] WHERE [reg_id] = @reg_id" InsertCommand="INSERT INTO [reg_user] ([reg_uname], [reg_pass], [reg_cpass], [email_id], [mobile_no], [reg_date], [role_id], [isvalid]) VALUES (@reg_uname, @reg_pass, @reg_cpass, @email_id, @mobile_no, @reg_date, @role_id, @isvalid)" ProviderName="<%$ ConnectionStrings:authuserConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [reg_user] WHERE ([isvalid] = @isvalid)" UpdateCommand="UPDATE [reg_user] SET [reg_uname] = @reg_uname, [reg_pass] = @reg_pass, [reg_cpass] = @reg_cpass, [email_id] = @email_id, [mobile_no] = @mobile_no, [reg_date] = @reg_date, [role_id] = @role_id, [isvalid] = @isvalid WHERE [reg_id] = @reg_id">
                        <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:authuserConnectionString %>" DeleteCommand="DELETE FROM [reg_user] WHERE [reg_id] = @reg_id" InsertCommand="INSERT INTO [reg_user] ([mobile_no], [email_id], [isvalid], [reg_uname], [reg_date], [role_id]) VALUES (@mobile_no, @email_id, @isvalid, @reg_uname, @reg_date, @role_id)" SelectCommand="SELECT [reg_id], [mobile_no], [email_id], [isvalid], [reg_uname], [reg_date], [role_id] FROM [reg_user] WHERE ([reg_id] = @reg_id)" UpdateCommand="UPDATE [reg_user] SET [mobile_no] = @mobile_no, [email_id] = @email_id, [isvalid] = @isvalid, [reg_uname] = @reg_uname, [reg_date] = @reg_date, [role_id] = @role_id WHERE [reg_id] = @reg_id">
            <DeleteParameters>
                <asp:Parameter Name="reg_id" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
