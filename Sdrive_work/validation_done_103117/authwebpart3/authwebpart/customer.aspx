            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="2" Height="545px" Width="978px"  OnFinishButtonClick="Wizard1_FinishButtonClick" BackColor="#FFFBD6" BorderColor="#FFDFAD" BorderWidth="1px" OnNextButtonClick="Wizard1_NextButtonClick">
                                    ...
                                    <asp:WizardStep runat="server" title="1-Customer Detail" >
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-lg-9">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidatort1" runat="server" ErrorMessage="FirstName Is Empty" ControlToValidate="TextBox1" Text="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-lg-9">
                                                <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control"></asp:TextBox>
                                                  <asp:RequiredFieldValidator ID="RequiredFieldValidatort2" runat="server" ErrorMessage="MiddleName Is Empty" ControlToValidate="TextBox2" Text="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-lg-9">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidatort3" runat="server" ErrorMessage="LastName Is Empty" ControlToValidate="TextBox3" Text="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-lg-9">
                                                <asp:DropDownList ID="DropDownList3" runat="server" CssClass="form-control">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatord1" runat="server" Text="*" ControlToValidate="DropDownList3"
                ErrorMessage="Not Selected City Required!" InitialValue="--Select--" ForeColor="Red" ></asp:RequiredFieldValidator>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-lg-9">
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidatort4" runat="server" ErrorMessage="Invalid Mobile No" ControlToValidate="TextBox7" ForeColor="Red" ValidationExpression="^9\d{9}$"></asp:RegularExpressionValidator>
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-lg-9">
                                                <asp:TextBox ID="TextBox18" runat="server" CssClass="form-control" ></asp:TextBox>
                                                  <asp:RequiredFieldValidator ID="rfvTextBox18" runat="server"  ControlToValidate="TextBox18" Text="*" ForeColor="Red"  >
                                                        </asp:RequiredFieldValidator>
                                                   <asp:RegularExpressionValidator ID="regexcr" runat="server"  ErrorMessage="Invalid-Credit Amount::Try Again"  ValidationExpression="^\d+([,\.]\d{1,2})?$" ControlToValidate="TextBox18" ForeColor="Red" ></asp:RegularExpressionValidator>
                                            </div>
                                        </div>
                                         <div class="form-group row">
