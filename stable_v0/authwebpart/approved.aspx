                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:stablev0scon %>" DeleteCommand="DELETE FROM [reg_user] WHERE [reg_id] = @reg_id" InsertCommand="INSERT INTO [reg_user] ([reg_uname], [email_id], [mobile_no], [reg_date], [isvalid]) VALUES (@reg_uname, @email_id, @mobile_no, @reg_date, @isvalid)" ProviderName="<%$ ConnectionStrings:stablev0scon.ProviderName %>" SelectCommand="SELECT [reg_id], [reg_uname], [email_id], [mobile_no], [reg_date], [isvalid] FROM [reg_user] WHERE ([isvalid] = @isvalid) ORDER BY [reg_date] DESC" UpdateCommand="UPDATE [reg_user] SET [reg_uname] = @reg_uname, [email_id] = @email_id, [mobile_no] = @mobile_no, [reg_date] = @reg_date, [isvalid] = @isvalid WHERE [reg_id] = @reg_id">
                                <DeleteParameters>
