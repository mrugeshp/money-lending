    ...
    public partial class customer : System.Web.UI.Page
    {
        ...
        protected void Wizard1_FinishButtonClick(object sender, WizardNavigationEventArgs e)
        {
            ...
            using (myConnection)
            {
                ...
                string cquery = "insert into customer ( c_fname,c_mname,c_lname,address,city,mobile_no,create_date,created_date,interest_rate,credit_limit,cphoto_path,mphoto_path)";
                cquery += "values(@c_fname,@c_mname,@c_lname,@address,@city,@mobile_no,@create_date,@created_date,@interest_rate,@credit_limit,@cphoto_path,@mphoto_path)";
