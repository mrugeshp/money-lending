                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <div style="clear:both;position:relative;zoom:1">
                            ...
                            <asp:GridView ID="GridView2" CssClass="table table-striped" runat="server" AutoGenerateColumns="False" DataKeyNames="c_id" DataSourceID="SqlDataSource2" Enabled="False" Visible="False" OnRowDataBound="GridView2_RowDataBound" >
                                <Columns>
                                    <asp:TemplateField HeaderText="c_id" InsertVisible="False" SortExpression="c_id">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:v0scon %>" DataSourceMode="DataReader" SelectCommand="SELECT * FROM [customer] WHERE ([mobile_no] = @mobile_no) ORDER BY [create_date] DESC" ProviderName="<%$ ConnectionStrings:v0scon.ProviderName %>">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="TextBox1" Name="mobile_no" PropertyName="Text" Type="Decimal" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                                    
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:v0scon %>" DataSourceMode="DataReader" SelectCommand="SELECT * FROM [customer] WHERE ([city] = @city)" ProviderName="<%$ ConnectionStrings:v0scon.ProviderName %>">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="TextBox1" Name="city" PropertyName="Text" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                                   
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:v0scon %>" SelectCommand="SELECT * FROM [customer] WHERE ((CONTAINS([c_fname], @c_fname) OR (CONTAINS([c_lname], @c_lname) OR (CONTAINS([c_mname], @c_mname)) " ProviderName="<%$ ConnectionStrings:v0scon.ProviderName %>">
                                <SelectParameters>
                            ...
                            <asp:GridView ID="GridView3" CssClass="searchID_GridView3 table table-striped" runat="server" AutoGenerateColumns="False" DataKeyNames="c_id" Enabled="False" Visible="False" OnRowDataBound="GridView3_RowDataBound" DataSourceID="SqlDataSource3" >
                                <Columns>
                                    <asp:TemplateField HeaderText="c_id" InsertVisible="False" SortExpression="c_id">
