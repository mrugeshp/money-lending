                                              ...
                                              <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                               <ContentTemplate>
                                                <td>
                                                    ...
                                                    <strong>Type:</strong> 
                                                        <asp:DropDownList ID="dropItem" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="dropItem_SelectedIndexChanged" >
                                                                <asp:ListItem >--Select--</asp:ListItem>
                                                ...
                                                <td>
                                                    <strong><asp:Label ID="gslabel" runat="server" Text="Rate(Rs/Kg):"></asp:Label></strong>
