                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" Text='<%# Bind("gross_weight") %>'></asp:TextBox>
                                              <asp:RequiredFieldValidator ID="vrequiredt1"  runat="server" ErrorMessage="gross weight empty !" ControlToValidate="TextBox1" Text="*" ForeColor="Red" ValidationGroup="vedit">
                                                        ...
                                                        <asp:RegularExpressionValidator ID="vregexgrossweight" runat="server" ErrorMessage="Invalid-Weight" ValidationExpression="^\d+([,\.]\d{1,2})?$" ControlToValidate="TextBox1" ForeColor="Red" ValidationGroup="vedit"></asp:RegularExpressionValidator>
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox3" CssClass="form-control" runat="server" Text='<%# Bind("rate") %>'></asp:TextBox>
                                             <asp:RequiredFieldValidator ID="vrequiredt3" runat="server" ErrorMessage="rate is a required !" ControlToValidate="TextBox3" Text="*" ForeColor="Red" ValidationGroup="vedit">
                                                          ...
                                                          <asp:RegularExpressionValidator ID="vregextextbox3" runat="server" ErrorMessage="Invalid-Rate" ValidationExpression="^\d+([,\.]\d{1,2})?$" ControlToValidate="TextBox3" ForeColor="Red" ValidationGroup="vedit"></asp:RegularExpressionValidator>        
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox2"  CssClass="form-control" runat="server" Text='<%# Bind("amount") %>'></asp:TextBox>
                                              <asp:RequiredFieldValidator ID="vrequiredt2" runat="server" ErrorMessage="amount is a required !" ControlToValidate="TextBox2" Text="*" ForeColor="Red" ValidationGroup="vedit">
                                                           ...
                                                           <asp:RegularExpressionValidator ID="vregextext2" runat="server" ErrorMessage="Invalid-Amount" ValidationExpression="^\d+([,\.]\d{1,2})?$" ControlToValidate="TextBox2" ForeColor="Red" ValidationGroup="vedit"></asp:RegularExpressionValidator>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                               ...
                               <asp:RequiredFieldValidator ID="vrequiredt17" runat="server"  ControlToValidate="TextBox17" Text="*" ForeColor="Red" ValidationGroup="vtrans" >
                                                   ...
                                                   <asp:RegularExpressionValidator ID="vregext17" runat="server" Text="Invalid-Transection Amount::Try Again"  ValidationExpression="^\d+([,\.]\d{1,2})?$" ControlToValidate="TextBox17" ForeColor="Red" ValidationGroup="vtrans" ></asp:RegularExpressionValidator>
                                 </div>
                            </div>
